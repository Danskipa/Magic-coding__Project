document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
  ...
  `;let t=e.querySelector(".leap-year-input"),u=e.querySelector(".leap-year-result");t.addEventListener("input",e=>{let t=Number(e.target.value);if(0===t){u.textContent="";return}t%4==0&&t%100!=0||t%400==0?(u.textContent="Ви народилися у високосний рік!",u.style.color="green"):(u.textContent="Ви народилися не у високосний рік.",u.style.color="black")})},id:1,name:"Високосний калькулятор",category:"numerical"},,{init:void 0,id:2,name:"Вгадай число",category:"numerical"},{id:3,name:"Камінь-Ножиці-Папір",category:"game"},{init:()=>{document.querySelector(".game-id_4").innerHTML=`<h2 class="calculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440}</h2>
        ...
        </div>`;let e=document.querySelector(".number__first"),t=document.querySelector(".numbe__second"),u=document.querySelector(".calculator__actions"),a=document.querySelector(".calculate"),s=document.querySelector(".result"),i="",n=0;u.addEventListener("click",e=>{document.querySelectorAll(".action").forEach(e=>{e.classList.remove("choose")}),e.target.classList.add("choose"),i=e.target.dataset.action}),a.addEventListener("click",u=>{n=0;let a=Number(e.value),l=Number(t.value);switch(console.log(a),i){case"add":s.textContent=n=a+l;break;case"mul":s.textContent=n=a*l;break;case"sub":s.textContent=n=a-l;break;case"div":0===l?s.textContent="На 0 ділити не можна":(n=a/l)%1==0?s.textContent=n:s.textContent=n.toFixed(2)}})},id:4,name:"Калькулятор",category:"numerical"},{init:()=>{document.querySelector(".game-id_5").innerHTML=`<h2 class="time-\u{441}alculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440} \u{447}\u{430}\u{441}\u{443}</h2>
...
<p class="biggest-num__text">\u{41D}\u{430}\u{439}\u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} \u{447}\u{438}\u{441}\u{43B}\u{43E}, \u{44F}\u{43A}\u{435} \u{432}\u{438} \u{432}\u{432}\u{435}\u{43B}\u{438} - (<span class="biggest-num__text--part">\u{447}\u{438}\u{441}\u{43B}\u{43E}</span>)</p>      </div>`;let e=document.querySelector("#biggest-num__input--one"),t=document.querySelector("#biggest-num__input--two"),u=document.querySelector("#biggest-num__input--three"),a=document.querySelector(".biggest-num__text--part"),s=()=>{let s=[Number(e.value),Number(t.value),Number(u.value)],i=s[0];for(let e=0;e<s.length;e++)s[e]>i&&(i=s[e]);a.textContent=`${0===i?"число":i}`};e.addEventListener("input",s),t.addEventListener("input",s),u.addEventListener("input",s)},id:8,name:"Найбільше число",category:"numerical"},{id:9,name:"Наша команда",category:"acquaintance"},{id:10,name:"Вчений",category:"acquaintance"}],t=document.querySelector(".modal"),u=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let a=document.querySelector(".form__input"),s=document.querySelector(".helloing__text--part"),i=document.querySelector(".form__button"),n=document.querySelector(".seconde__modal"),l=document.querySelector(".close__button");document.querySelector(".logo__link--picture");let o=document.querySelector(".logo__link_photo--white"),r=document.querySelector(".logo__link_photo--dark"),c=document.querySelectorAll(".menu__item");document.querySelectorAll(".game");let d=document.querySelectorAll(".section");u.addEventListener("change",e=>{e.target.checked?(document.body.classList.add("dark"),o.classList.add("dark_logo"),r.classList.add("dark_logo"),c.forEach(e=>{e.classList.add("menu__item--dark")})):(document.body.classList.remove("dark"),o.classList.remove("dark_logo"),r.classList.remove("dark_logo"),c.forEach(e=>{e.classList.remove("menu__item--dark")}))}),a.addEventListener("input",e=>{s.textContent=e.target.value}),i.addEventListener("click",e=>{i&&n.classList.remove("hidden")}),l.addEventListener("click",e=>{l&&(t.classList.add("hidden"),n.classList.add("hidden"))});let m=document.querySelectorAll(".menu__text"),g=t=>{let u=t.currentTarget.dataset.category;d.forEach((t,a)=>{e[a].category===u?t.style.display="block":t.style.display="none"})};m.forEach(e=>{e.addEventListener("click",g)}),document.querySelector("[data-games]").innerHTML=e.reduce((e,t)=>e+=`      
    <section id="game-id_${t.id}" class="section">
        <div class="container">
          <div class="game game-id_${t.id}">
          </div>
        </div>
      </section>`,""),e.forEach(e=>{e.init&&e.init()});let _=document.querySelector(".footer-form"),h=document.querySelector("[data-modal]"),p=document.querySelector("[data-modal-close]");console.log("Форма:",_),console.log("Бекдроп:",h),console.log("Кнопка закриття:",p),_.addEventListener("submit",e=>{e.preventDefault(),h.classList.remove("is-hidden"),_.reset()}),p.addEventListener("click",e=>{e.preventDefault(),h.classList.add("is-hidden")});
//# sourceMappingURL=Magic-coding__Project.475feec7.js.map
