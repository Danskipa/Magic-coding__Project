var e="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},t={},u={},o=e.parcelRequire1ad7;null==o&&((o=function(e){if(e in t)return t[e].exports;if(e in u){var o=u[e];delete u[e];var a={id:e,exports:{}};return t[e]=a,o.call(a.exports,a,a.exports),a.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){u[e]=t},e.parcelRequire1ad7=o),o.register,Object.assign(o.i??={},{hVAk2:"arrow-check.d4bc1386.svg"});let a=document.querySelector("html"),r=document.querySelector(".backdrop__header"),s=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let l=document.querySelector(".form__input"),n=document.querySelector(".helloing__text--part");document.querySelector(".form__button");let i=document.querySelector(".seconde__backdrop__header"),c=document.querySelector(".close__button");document.querySelector(".logo__link--picture");let d=document.querySelector(".logo__link_photo--white"),m=document.querySelector(".logo__link_photo--dark");document.querySelectorAll(".game");let _=document.querySelector(".modal__form"),g=document.querySelector(".modal__photo--seconde"),p=document.querySelector(".modals");s.addEventListener("change",e=>{e.target.checked?(a.style.setProperty("--colorBgPrimary","#000000db"),a.style.setProperty("--colorTextPrimary","#ffffffb9"),d.classList.add("dark_logo"),m.classList.add("dark_logo"),menuItems.forEach(e=>{e.classList.add("menu__item--dark")})):(a.style.setProperty("--colorCorrect","#039900"),a.style.setProperty("--colorIncorrect","#990000"),a.style.setProperty("--colorBgPrimary","#ffffff"),a.style.setProperty("--colorBgSecondary","#d9d9d9"),a.style.setProperty("--colorBgField","#d7d7d7"),a.style.setProperty("--colorBgSwitch","#7a7a7a"),a.style.setProperty("--colorBgChoose","#f1f1f1"),a.style.setProperty("--colorTextPrimary","#000000"),a.style.setProperty("--colorTextSecondary","#7e7e7e"),d.classList.remove("dark_logo"),m.classList.remove("dark_logo"),menuItems.forEach(e=>{e.classList.remove("menu__item--dark")}))}),l.addEventListener("input",e=>{n.textContent=e.target.value}),_.addEventListener("submit",e=>{e.preventDefault(),i.classList.remove("hidden")}),c.addEventListener("click",e=>{g.classList.add("hidden"),r.classList.add("hidden"),i.classList.add("hidden"),p.classList.add("hidden")}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
...
`;let r=e.querySelector(".rps-text"),s=e.querySelector("#cpu-score"),l=e.querySelector("#player-score"),n=e.querySelectorAll(".rps-button__option"),i=e.querySelector(".rps-button"),c=e.querySelectorAll(".rps-item"),d=e=>{o=e.target.dataset.choice,c.forEach(e=>e.classList.remove("active")),e.target.parentElement.classList.add("active")};i.addEventListener("click",e=>{let n=a[Math.floor(Math.random()*a.length)];"rock"===o&&"rock"===n?(r.textContent="Нічия в цьому раунді!",r.style.color="#000000"):"rock"===o&&"scissors"===n?(u++,r.textContent="Ви виграли раунд!",r.style.color="#039900"):"rock"===o&&"paper"===n&&(t++,r.textContent="Комп’ютер виграв раунд!",r.style.color="#990000"),"scissors"===o&&"scissors"===n?(r.textContent="Нічия в цьому раунді!",r.style.color="#000000"):"scissors"===o&&"paper"===n?(u++,r.textContent="Ви виграли раунд!",r.style.color="#039900"):"scissors"===o&&"rock"===n&&(t++,r.textContent="Комп’ютер виграв раунд!",r.style.color="#990000"),"paper"===o&&"paper"===n?(r.textContent="Нічия в цьому раунді!",r.style.color="#000000"):"paper"===o&&"rock"===n?(u++,r.textContent="Ви виграли раунд!",r.style.color="#039900"):"paper"===o&&"scissors"===n&&(t++,r.textContent="Комп’ютер виграв раунд!",r.style.color="#990000"),o="",s.textContent=`\u{41A}\u{43E}\u{43C}\u{43F}'\u{44E}\u{442}\u{435}\u{440} - ${t}`,l.textContent=`\u{412}\u{438} - ${u}`}),n.forEach(e=>{e.addEventListener("click",d)})},id:3,name:"Камінь-Ножиці-Папір",category:"game"},{init:()=>{document.querySelector(".game-id_4").innerHTML=`<h2 class="calculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440}</h2>
        ...
        </div>`;let e=document.querySelector(".number__first"),t=document.querySelector(".numbe__second"),u=document.querySelector(".calculator__actions"),o=document.querySelector(".calculate"),a=document.querySelector(".result"),r="",s=0;u.addEventListener("click",e=>{document.querySelectorAll(".action").forEach(e=>{e.classList.remove("choose")}),e.target.classList.add("choose"),r=e.target.dataset.action}),o.addEventListener("click",u=>{s=0;let o=Number(e.value),l=Number(t.value);switch(console.log(o),r){case"add":a.textContent=s=o+l;break;case"mul":a.textContent=s=o*l;break;case"sub":a.textContent=s=o-l;break;case"div":0===l?a.textContent="На 0 ділити не можна":(s=o/l)%1==0?a.textContent=s:a.textContent=s.toFixed(2)}})},id:4,name:"Калькулятор",category:"numerical"},{init:()=>{document.querySelector(".game-id_5").innerHTML=`<h2 class="time-\u{441}alculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440} \u{447}\u{430}\u{441}\u{443}</h2>
...
<p class="biggest-num__text">\u{41D}\u{430}\u{439}\u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} \u{447}\u{438}\u{441}\u{43B}\u{43E}, \u{44F}\u{43A}\u{435} \u{432}\u{438} \u{432}\u{432}\u{435}\u{43B}\u{438} - (<span class="biggest-num__text--part">\u{447}\u{438}\u{441}\u{43B}\u{43E}</span>)</p>      </div>`;let e=document.querySelector("#biggest-num__input--one"),t=document.querySelector("#biggest-num__input--two"),u=document.querySelector("#biggest-num__input--three"),o=document.querySelector(".biggest-num__text--part"),a=()=>{let a=[Number(e.value),Number(t.value),Number(u.value)],r=a[0];for(let e=0;e<a.length;e++)a[e]>r&&(r=a[e]);o.textContent=`${0===r?"число":r}`};e.addEventListener("input",a),t.addEventListener("input",a),u.addEventListener("input",a)},id:8,name:"Найбільше число",category:"numerical"},{id:9,name:"Наша команда",category:"acquaintance"},{id:10,name:"Вчений",category:"acquaintance"},{init:()=>{let e;document.querySelector(".game-id_11").innerHTML=`
            ...
            </div>`;let t=document.querySelector(".tone__controls"),u=document.querySelector(".tone__box--user"),o=document.querySelector(".tone__box--current"),a=document.querySelector(".btn__done"),r=document.querySelector(".btn__next"),s=document.querySelector(".tone__meta"),l=document.querySelector(".similarity"),n=document.querySelectorAll(".tone__range"),i=[],c=[],d=()=>{let t=Math.floor(255*Math.random()),u=Math.floor(255*Math.random()),a=Math.floor(255*Math.random());i=[t,u,a],e=`rgb(${t}, ${u}, ${a})`,o.style.backgroundColor=e},m=()=>{let e=document.querySelector(".tone__range--red").value,t=document.querySelector(".tone__range--green").value,o=document.querySelector(".tone__range--blue").value;c=[e,t,o];let a=`rgb(${e}, ${t}, ${o})`;u.style.backgroundColor=a},_=0;d(),t.addEventListener("input",m),a.addEventListener("click",()=>{let t;m();var o=i,a=c;let r=0;for(let e=0;e<3;e++)r+=100-100*Math.abs(o[e]-a[e])/255;_=Math.floor(r/3),l.style.color=c[0]<167&&c[1]<167&&c[2]<167?"var(--colorBgPrimary)":"var(--colorTextPrimary)",l.textContent=`${_} %`,(t=document.createElement("div")).classList.add("box__reference"),t.style.backgroundColor=e,u.appendChild(t)}),r.addEventListener("click",()=>{d(),u.querySelector(".box__reference").remove(),l.textContent="",n.forEach(e=>{e.value=128}),u.style.backgroundColor="rgb(128, 128, 128)"}),s.addEventListener("click",()=>{a.classList.toggle("is__closed"),r.classList.toggle("is__closed"),t.classList.toggle("is__closed")})},id:11,name:"Вгадай колір",category:"game"}],h=document.querySelector("[data-games]"),b=(e,t)=>{t.innerHTML=e.reduce((e,t)=>e+=`      
    <section id="game-id_${t.id}" class="section">
        <div class="container">
          <div class="game game-id_${t.id}">
          </div>
        </div>
      </section>`,""),e.forEach(e=>{e.init&&e.init()})};b(y,h),document.querySelectorAll(".section");let v=document.querySelectorAll(".menu__item");document.querySelectorAll(".menu__text");let S=e=>{let t=e.currentTarget.dataset.category;b(y.filter(e=>e.category===t),h)};v.forEach(e=>{e.addEventListener("click",S)});let q=document.querySelector(".footer-form"),f=document.querySelector("[data-modal]"),L=document.querySelector("[data-modal-close]");console.log("Форма:",q),console.log("Бекдроп:",f),console.log("Кнопка закриття:",L),q.addEventListener("submit",e=>{e.preventDefault(),f.classList.remove("is-hidden"),q.reset()}),L.addEventListener("click",e=>{e.preventDefault(),f.classList.add("is-hidden")});
//# sourceMappingURL=Magic-coding__Project.568005e2.js.map
