let e=document.querySelector(".modal"),t=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let u=document.querySelector(".form__input"),a=document.querySelector(".helloing__text--part"),s=document.querySelector(".form__button"),i=document.querySelector(".seconde__modal"),n=document.querySelector(".close__button");document.querySelector(".logo__link--picture");let r=document.querySelector(".logo__img");t.addEventListener("change",e=>{e.target.checked?(document.body.classList.add("dark"),logoPickture.classList.add("logo__photo--dark"),r.src="./images/logo.svg"):(document.body.classList.remove("dark"),logoPickture.classList.remove("logo__photo--dark"),r.src="./images/logo_dark.svg")}),u.addEventListener("input",e=>{a.textContent=e.target.value}),s.addEventListener("click",e=>{s&&i.classList.remove("hidden")}),n.addEventListener("click",t=>{n&&(e.classList.add("hidden"),i.classList.add("hidden"))}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
