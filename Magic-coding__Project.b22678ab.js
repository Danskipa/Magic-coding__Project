...
<p class="biggest-num__text">\u{41D}\u{430}\u{439}\u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} \u{447}\u{438}\u{441}\u{43B}\u{43E}, \u{44F}\u{43A}\u{435} \u{432}\u{438} \u{432}\u{432}\u{435}\u{43B}\u{438} - (<span class="biggest-num__text--part">\u{447}\u{438}\u{441}\u{43B}\u{43E}</span>)</p>      </div>`;let e=document.querySelector("#biggest-num__input--one"),t=document.querySelector("#biggest-num__input--two"),u=document.querySelector("#biggest-num__input--three"),o=document.querySelector(".biggest-num__text--part"),r=()=>{let r=[Number(e.value),Number(t.value),Number(u.value)],a=r[0];for(let e=0;e<r.length;e++)r[e]>a&&(a=r[e]);o.textContent=`${0===a?"число":a}`};e.addEventListener("input",r),t.addEventListener("input",r),u.addEventListener("input",r)},id:8,name:"Найбільше число",category:"numerical"},{id:9,name:"Наша команда",category:"acquaintance"},{id:10,name:"Вчений",category:"acquaintance"},{init:()=>{let e;document.querySelector(".game-id_11").innerHTML=`
            ...
            </div>`;let t=document.querySelector(".tone__controls"),u=document.querySelector(".tone__box--user"),o=document.querySelector(".tone__box--current"),r=document.querySelector(".btn__done"),a=document.querySelector(".btn__next"),s=document.querySelector(".tone__meta"),l=document.querySelector(".similarity"),n=document.querySelectorAll(".tone__range"),i=[],c=[],d=()=>{let t=Math.floor(255*Math.random()),u=Math.floor(255*Math.random()),r=Math.floor(255*Math.random());i=[t,u,r],e=`rgb(${t}, ${u}, ${r})`,o.style.backgroundColor=e},m=()=>{let e=document.querySelector(".tone__range--red").value,t=document.querySelector(".tone__range--green").value,o=document.querySelector(".tone__range--blue").value;c=[e,t,o];let r=`rgb(${e}, ${t}, ${o})`;u.style.backgroundColor=r},_=0;d(),t.addEventListener("input",m),r.addEventListener("click",()=>{let t;m();var o=i,r=c;let a=0;for(let e=0;e<3;e++)a+=100-100*Math.abs(o[e]-r[e])/255;_=Math.floor(a/3),l.style.color=c[0]<167&&c[1]<167&&c[2]<167?"var(--colorBgPrimary)":"var(--colorTextPrimary)",l.textContent=`${_} %`,(t=document.createElement("div")).classList.add("box__reference"),t.style.backgroundColor=e,u.appendChild(t)}),a.addEventListener("click",()=>{d(),u.querySelector(".box__reference").remove(),l.textContent="",n.forEach(e=>{e.value=128}),u.style.backgroundColor="rgb(128, 128, 128)"}),s.addEventListener("click",()=>{r.classList.toggle("is__closed"),a.classList.toggle("is__closed"),t.classList.toggle("is__closed")})},id:11,name:"Вгадай колір",category:"game"}],a=document.querySelector("html"),s=document.querySelector(".modal"),l=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let n=document.querySelector(".form__input"),i=document.querySelector(".helloing__text--part"),c=document.querySelector(".form__button"),d=document.querySelector(".seconde__modal"),m=document.querySelector(".close__button");document.querySelector(".logo__link--picture");let _=document.querySelector(".logo__link_photo--white"),g=document.querySelector(".logo__link_photo--dark"),p=document.querySelectorAll(".menu__item");document.querySelectorAll(".game");let y=document.querySelectorAll(".section"),h=document.querySelector(".modal__form");l.addEventListener("change",e=>{e.target.checked?(a.style.setProperty("--colorCorrect","#ff0086"),a.style.setProperty("--colorIncorrect","#00ff48"),a.style.setProperty("--colorBgPrimary","#000000"),a.style.setProperty("--colorBgSecondary","#595959"),a.style.setProperty("--colorTextPrimary","#ffffff"),_.classList.add("dark_logo"),g.classList.add("dark_logo"),p.forEach(e=>{e.classList.add("menu__item--dark")})):(a.style.setProperty("--colorCorrect","#039900"),a.style.setProperty("--colorIncorrect","#990000"),a.style.setProperty("--colorBgPrimary","#ffffff"),a.style.setProperty("--colorBgSecondary","#d9d9d9"),a.style.setProperty("--colorBgField","#d7d7d7"),a.style.setProperty("--colorBgSwitch","#7a7a7a"),a.style.setProperty("--colorBgChoose","#f1f1f1"),a.style.setProperty("--colorTextPrimary","#000000"),a.style.setProperty("--colorTextSecondary","#7e7e7e"),_.classList.remove("dark_logo"),g.classList.remove("dark_logo"),p.forEach(e=>{e.classList.remove("menu__item--dark")}))}),n.addEventListener("input",e=>{i.textContent=e.target.value}),h.addEventListener("submit",e=>{e.preventDefault(),c&&d.classList.remove("hidden")}),m.addEventListener("click",e=>{m&&(s.classList.add("hidden"),d.classList.add("hidden"))}),document.querySelectorAll(".menu__text");let b=e=>{let t=e.currentTarget.dataset.category;y.forEach((e,u)=>{r[u].category===t?e.style.display="block":e.style.display="none"})};p.forEach(e=>{e.addEventListener("click",b)}),document.querySelector("[data-games]").innerHTML=r.reduce((e,t)=>e+=`      
...
//# sourceMappingURL=Magic-coding__Project.b22678ab.js.map
