...
`;let o=e.querySelector(".rps-text"),n=e.querySelector("#cpu-score"),a=e.querySelector("#player-score"),r=e.querySelectorAll(".rps-button__option"),l=e.querySelector(".rps-button"),c=e=>{s=e.target.dataset.choice,r.forEach(e=>e.classList.remove("rps-button__option--active")),e.target.classList.add("rps-button__option--active")};l.addEventListener("click",e=>{let r=i[Math.floor(Math.random()*i.length)];"rock"===s&&"rock"===r?(o.textContent="Нічия в цьому раунді!",o.style.color="#000000"):"rock"===s&&"scissors"===r?(u++,o.textContent="Ви виграли раунд!",o.style.color="#039900"):"rock"===s&&"paper"===r&&(t++,o.textContent="Комп’ютер виграв раунд!",o.style.color="#990000"),"scissors"===s&&"scissors"===r?(o.textContent="Нічия в цьому раунді!",o.style.color="#000000"):"scissors"===s&&"paper"===r?(u++,o.textContent="Ви виграли раунд!",o.style.color="#039900"):"scissors"===s&&"rock"===r&&(t++,o.textContent="Комп’ютер виграв раунд!",o.style.color="#990000"),"paper"===s&&"paper"===r?(o.textContent="Нічия в цьому раунді!",o.style.color="#000000"):"paper"===s&&"rock"===r?(u++,o.textContent="Ви виграли раунд!",o.style.color="#039900"):"paper"===s&&"scissors"===r&&(t++,o.textContent="Комп’ютер виграв раунд!",o.style.color="#990000"),s="",n.textContent=`\u{41A}\u{43E}\u{43C}\u{43F}'\u{44E}\u{442}\u{435}\u{440} - ${t}`,a.textContent=`\u{412}\u{438} - ${u}`}),r.forEach(e=>{e.addEventListener("click",c)})},id:3,name:"Камінь-Ножиці-Папір",category:"game"},{init:()=>{document.querySelector(".game-id_4").innerHTML=`<h2 class="calculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440}</h2>
        ...
        </div>`;let e=document.querySelector(".number__first"),t=document.querySelector(".numbe__second"),u=document.querySelector(".calculator__actions"),s=document.querySelector(".calculate"),i=document.querySelector(".result"),o="",n=0;u.addEventListener("click",e=>{document.querySelectorAll(".action").forEach(e=>{e.classList.remove("choose")}),e.target.classList.add("choose"),o=e.target.dataset.action}),s.addEventListener("click",u=>{n=0;let s=Number(e.value),a=Number(t.value);switch(console.log(s),o){case"add":i.textContent=n=s+a;break;case"mul":i.textContent=n=s*a;break;case"sub":i.textContent=n=s-a;break;case"div":0===a?i.textContent="На 0 ділити не можна":(n=s/a)%1==0?i.textContent=n:i.textContent=n.toFixed(2)}})},id:4,name:"Калькулятор",category:"numerical"},{init:()=>{document.querySelector(".game-id_5").innerHTML=`<h2 class="time-\u{441}alculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440} \u{447}\u{430}\u{441}\u{443}</h2>
...
\u{44F}\u{43A}\u{438}\u{439} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432} \u{43D}\u{430}\u{439}\u{43C}\u{435}\u{43D}\u{448}\u{435}</button></li>
  ...
  `;let t=e.querySelector(".scientists-cards"),u=()=>Array.from(t.querySelectorAll(".scientists-card-item")),s=e=>{let t=e.slice(e.length-9);return(t[0]+t[1]+t[2]+t[3])*1},i=e=>{let t,u,i;return u=(t=e.slice(e.length-9))[5],i=t[6],(u+i+t[7]+t[8])*1-s(e)};e.querySelector("#btn-born19").addEventListener("click",()=>{let e=u().filter(e=>{let t=s(e.textContent);return t>=1801&&t<=1900});t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-sortAlphabet").addEventListener("click",()=>{let e=u().sort((e,t)=>e.textContent.localeCompare(t.textContent));t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-sortLifespan").addEventListener("click",()=>{let e=u().sort((e,t)=>i(t.textContent)-i(e.textContent));t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-latestBorn").addEventListener("click",()=>{let e=u(),i=e[0];e.forEach(e=>{s(e.textContent)>s(i.textContent)&&(i=e)}),t.innerHTML="",t.appendChild(i)}),e.querySelector("#btn-einstein").addEventListener("click",()=>{let e=u(),s=null;e.forEach(e=>{-1!==e.textContent.indexOf("Albert Einstein")&&(s=e)}),null!==s&&(t.innerHTML="",t.appendChild(s))}),e.querySelector("#btn-lastNameC").addEventListener("click",()=>{u().forEach(e=>{"C"!==e.textContent.split(" ")[1][0]&&e.remove()})}),e.querySelector("#btn-removeA").addEventListener("click",()=>{u().forEach(e=>{"A"===e.textContent.split(" ")[0][0]&&e.remove()})}),e.querySelector("#btn-longShort").addEventListener("click",()=>{let e=u(),s=e[0],o=e[0];e.forEach(e=>{let t=i(e.textContent);t>i(s.textContent)&&(s=e),t<i(o.textContent)&&(o=e)}),t.innerHTML="",t.appendChild(s),t.appendChild(o)}),e.querySelector("#btn-sameInitials").addEventListener("click",()=>{u().forEach(e=>{let t=e.textContent.split(" ");t[0][0]!==t[1][0]&&e.remove()})})},id:10,name:"Вчений",category:"acquaintance"},{init:()=>{let e;document.querySelector(".game-id_11").innerHTML=`
            ...
            </div>`;let t=document.querySelector(".tone__controls"),u=document.querySelector(".tone__box--user"),s=document.querySelector(".tone__box--current"),i=document.querySelector(".btn__done"),o=document.querySelector(".btn__next"),n=document.querySelector(".tone__meta"),a=document.querySelector(".similarity"),r=document.querySelectorAll(".tone__range"),l=[],c=[],d=()=>{let t=Math.floor(255*Math.random()),u=Math.floor(255*Math.random()),i=Math.floor(255*Math.random());l=[t,u,i],e=`rgb(${t}, ${u}, ${i})`,s.style.backgroundColor=e},m=()=>{let e=document.querySelector(".tone__range--red").value,t=document.querySelector(".tone__range--green").value,s=document.querySelector(".tone__range--blue").value;c=[e,t,s];let i=`rgb(${e}, ${t}, ${s})`;u.style.backgroundColor=i},_=0;d(),t.addEventListener("input",m),i.addEventListener("click",()=>{let t;m();var s=l,i=c;let o=0;for(let e=0;e<3;e++)o+=100-100*Math.abs(s[e]-i[e])/255;_=Math.floor(o/3),a.style.color=c[0]<167&&c[1]<167&&c[2]<167?"var(--colorBgPrimary)":"var(--colorTextPrimary)",a.textContent=`${_} %`,(t=document.createElement("div")).classList.add("box__reference"),t.style.backgroundColor=e,u.appendChild(t)}),o.addEventListener("click",()=>{d(),u.querySelector(".box__reference").remove(),a.textContent="",r.forEach(e=>{e.value=128}),u.style.backgroundColor="rgb(128, 128, 128)"}),n.addEventListener("click",()=>{i.classList.toggle("is__closed"),o.classList.toggle("is__closed"),t.classList.toggle("is__closed")})},id:11,name:"Вгадай колір",category:"game"}],h=document.querySelector("[data-games]"),E=(e,t)=>{t.innerHTML=e.reduce((e,t)=>e+=`      
...
//# sourceMappingURL=Magic-coding__Project.f368c807.js.map
