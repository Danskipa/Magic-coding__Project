var e="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},t={},u={},s=e.parcelRequire1ad7;null==s&&((s=function(e){if(e in t)return t[e].exports;if(e in u){var s=u[e];delete u[e];var i={id:e,exports:{}};return t[e]=i,s.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){u[e]=t},e.parcelRequire1ad7=s),s.register,Object.assign(s.i??={},{hVAk2:"arrow-check.d4bc1386.svg"});let i=document.querySelector("html"),n=document.querySelector(".backdrop__header"),o=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let a=document.querySelector(".form__input"),l=document.querySelector(".helloing__text--part");document.querySelector(".form__button");let r=document.querySelector(".seconde__backdrop__header"),c=document.querySelectorAll(".close__button"),d=document.querySelector(".logo__link_photo--white"),m=document.querySelector(".logo__link_photo--dark"),p=document.querySelector(".footer__logo__link_photo--white"),_=document.querySelector(".footer__logo__link_photo--dark");document.querySelectorAll(".game");let v=document.querySelector(".modal__form"),g=document.querySelector(".modal__photo--seconde");document.querySelector(".modals");let y=e=>{g.classList.add("hidden"),n.classList.add("hidden"),r.classList.add("hidden")};o.addEventListener("change",e=>{e.target.checked?(i.style.setProperty("--colorBgMain","#111111"),i.style.setProperty("--colorCorrect","#FC66FF"),i.style.setProperty("--colorIncorrect","#66FFFF"),i.style.setProperty("--colorBgPrimary","#1a1a1a"),i.style.setProperty("--colorBgSecondary","#262626"),i.style.setProperty("--colorBgField","#282828"),i.style.setProperty("--colorBgSwitch","#858585"),i.style.setProperty("--colorBgChoose","#0E0E0E"),i.style.setProperty("--colorTextPrimary","#ffffffb9"),i.style.setProperty("--colorTextSecondary","#818181"),i.style.setProperty("--colorBgRPS","#282828"),d.classList.add("dark_logo"),m.classList.add("dark_logo"),p.classList.add("dark_logo"),_.classList.add("dark_logo")):(i.style.setProperty("--colorBgMain","#eeeeee"),i.style.setProperty("--colorCorrect","#039900"),i.style.setProperty("--colorIncorrect","#990000"),i.style.setProperty("--colorBgPrimary","#ffffff"),i.style.setProperty("--colorBgSecondary","#d9d9d9"),i.style.setProperty("--colorBgField","#d7d7d7"),i.style.setProperty("--colorBgSwitch","#7a7a7a"),i.style.setProperty("--colorBgChoose","#f1f1f1"),i.style.setProperty("--colorTextPrimary","#000000"),i.style.setProperty("--colorTextSecondary","#7e7e7e"),d.classList.remove("dark_logo"),m.classList.remove("dark_logo"),p.classList.remove("dark_logo"),_.classList.remove("dark_logo"))}),a.addEventListener("input",e=>{l.textContent=e.target.value}),v.addEventListener("submit",e=>{e.preventDefault(),r.classList.remove("hidden")}),c.forEach(e=>{e.addEventListener("click",y)}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
