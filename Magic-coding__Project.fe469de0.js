var e="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},t={},u={},s=e.parcelRequire1ad7;null==s&&((s=function(e){if(e in t)return t[e].exports;if(e in u){var s=u[e];delete u[e];var i={id:e,exports:{}};return t[e]=i,s.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){u[e]=t},e.parcelRequire1ad7=s),s.register,Object.assign(s.i??={},{hVAk2:"arrow-check.d4bc1386.svg"}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
  ...
  `;let t=e.querySelector(".leap-year-input"),u=e.querySelector(".leap-year-result");t.addEventListener("input",e=>{let t=Number(e.target.value);if(0===t){u.textContent="";return}t%4==0&&t%100!=0||t%400==0?(u.textContent="Ви народилися у високосний рік!",u.style.color="var(--colorCorrect)"):(u.textContent="Ви народилися не у високосний рік.",u.style.color="var(--colorIncorrect)")})},id:1,name:"Високосний калькулятор",category:"numerical"},{init:void 0,id:2,name:"Вгадай число",category:"numerical"},{init:()=>{let e=document.querySelector(".game-id_3"),t=0,u=0,s="",i=["rock","scissors","paper"];e.innerHTML=`
...
<div class="swiper">
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <div class="content content__danya">
        ...
        <p class="content__name">\u{414}\u{430}\u{43D}\u{44F}</p>
        <p class="content__worked">\u{41B}\u{456}\u{434}\u{435}\u{440} \u{43D}\u{430}\u{448}\u{43E}\u{457} \u{43A}\u{43E}\u{43C}\u{430}\u{43D}\u{434}\u{438}</p>
      </div>
    </div>
    ...
    <div class="swiper-slide">
      <div class="content content">
        ...
        <p class="content__name">\u{410}\u{43D}\u{43D}\u{430}</p>
        <p class="content__worked">\u{41D}\u{430}\u{448} \u{441}\u{43A}\u{440}\u{430}\u{43C} \u{43C}\u{430}\u{439}\u{441}\u{442}\u{435}\u{440}</p>
      </div>
    </div>
    ...
    <div class="swiper-slide">
      <div class="content">
        ...
        <p class="content__name">\u{424}\u{456}\u{43B}\u{456}\u{43F}</p>
        <p class="content__worked">\u{417}\u{432}\u{438}\u{447}\u{430}\u{439}\u{43D}\u{438}\u{439} \u{440}\u{43E}\u{437}\u{440}\u{43E}\u{431}\u{43D}\u{438}\u{43A}</p>
      </div>
    </div>
    ...
    <div class="swiper-slide">
      <div class="content content">
        ...
        <p class="content__name">\u{410}\u{440}\u{442}\u{435}\u{43C}</p>
        <p class="content__worked">\u{417}\u{432}\u{438}\u{447}\u{430}\u{439}\u{43D}\u{438}\u{439} \u{440}\u{43E}\u{437}\u{440}\u{43E}\u{431}\u{43D}\u{438}\u{43A}</p>
      </div>
    </div>
    ...
    <div class="swiper-slide">
      <div class="content">
        ...
        <p class="content__name">\u{410}\u{43D}\u{434}\u{440}\u{456}\u{439}</p>
        <p class="content__worked">\u{417}\u{432}\u{438}\u{447}\u{430}\u{439}\u{43D}\u{438}\u{439} \u{440}\u{43E}\u{437}\u{440}\u{43E}\u{431}\u{43D}\u{438}\u{43A}</p>
      </div>
    </div>
    ...
    <div class="swiper-slide">
      <div class="content content">
        ...
        <p class="content__name ">\u{412}\u{43B}\u{430}\u{434}</p>
        <p class="content__worked">\u{417}\u{432}\u{438}\u{447}\u{430}\u{439}\u{43D}\u{438}\u{439} "\u{440}\u{43E}\u{437}\u{440}\u{43E}\u{431}\u{43D}\u{438}\u{43A}"</p>
      </div>
    </div>
  </div>
  ...
  <div class="swiper-pagination"></div>
    ...
    `,new Swiper(".swiper",{effect:"creative",creativeEffect:{prev:{translate:["-80%",0,0],scale:.5},next:{translate:["80%",0,0],scale:.5}},loop:!0,slidesPerView:3,centeredSlides:!0,pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{320:{slidesPerView:1}}});let e=document.querySelector(".switcher"),t=document.querySelector('[data-swiper="left"]'),u=document.querySelector('[data-swiper="right"]');e.addEventListener("change",e=>{e.target.checked?(t.classList.add("dark"),u.classList.add("dark")):(t.classList.remove("dark"),u.classList.remove("dark"))})},id:9,name:"Наша команда",category:"acquaintance"},{init:()=>{let e=document.querySelector(".game-id_10");e.innerHTML=`
   <h3 class="scientists-title">\u{41E}\u{431}\u{435}\u{440}\u{438} \u{432}\u{447}\u{435}\u{43D}\u{43E}\u{433}\u{43E}/\u{438}\u{445}</h3>
     ...
     <ul class="scientists-tasks">
       <li class="scientists-item scientists-item--odd"><button id="btn-born19" class="scientists-btn scientists-btn--odd">\u{42F}\u{43A}\u{456} \u{432}\u{447}\u{435}\u{43D}\u{456} \u{43D}\u{430}\u{440}\u{43E}\u{434}\u{438}\u{43B}\u{438}\u{441}\u{44F} \u{432} 19 \u{441}\u{442}.</button></li>
              <li class="scientists-item scientists-item--even"><button id="btn-einstein" class="scientists-btn scientists-btn--even">\u{417}\u{43D}\u{430}\u{439}\u{442}\u{438} \u{440}\u{456}\u{43A} \u{43D}\u{430}\u{440}\u{43E}\u{434}\u{436}\u{435}\u{43D}\u{43D}\u{44F} Albert Einstein</button></li>
       <li class="scientists-item scientists-item--odd"><button id="btn-sortAlphabet" class="scientists-btn scientists-btn--odd">\u{412}\u{456}\u{434}\u{441}\u{43E}\u{440}\u{442}\u{443}\u{432}\u{430}\u{442}\u{438} \u{432}\u{447}\u{435}\u{43D}\u{438}\u{445} \u{437}\u{430} \u{430}\u{43B}\u{444}\u{430}\u{432}\u{456}\u{442}\u{43E}\u{43C}</button></li>
              <li class="scientists-item scientists-item--even"><button id="btn-lastNameC" class="scientists-btn scientists-btn--c scientists-btn--even">\u{417}\u{43D}\u{430}\u{439}\u{442}\u{438} \u{432}\u{447}\u{435}\u{43D}\u{438}\u{445}, \u{43F}\u{440}\u{456}\u{437}\u{432}\u{438}\u{449}\u{430} \u{44F}\u{43A}\u{438}\u{445} \u{43F}\u{43E}\u{447}\u{438}\u{43D}\u{430}\u{44E}\u{442}\u{44C}\u{441}\u{44F} \u{43D}\u{430} \u{43D}\u{430} \u{43B}\u{456}\u{442}\u{435}\u{440}\u{443} \u{201C}\u{421}\u{201D} </button></li>
       <li class="scientists-item scientists-item--odd"><button id="btn-sortLifespan" class="scientists-btn scientists-btn--odd">\u{412}\u{456}\u{434}\u{441}\u{43E}\u{440}\u{442}\u{443}\u{432}\u{430}\u{442}\u{438} \u{432}\u{447}\u{435}\u{43D}\u{438}\u{445} \u{437}\u{430} \u{43A}\u{456}\u{43B}\u{44C}\u{43A}\u{456}\u{441}\u{442}\u{44E} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{442}\u{438}\u{445} \u{440}\u{43E}\u{43A}\u{456}\u{432}</button></li>
              <li class="scientists-item scientists-item--even"><button id="btn-removeA" class="scientists-btn scientists-btn--even">\u{412}\u{438}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{438} \u{432}\u{441}\u{456}\u{445} \u{432}\u{447}\u{435}\u{43D}\u{438}\u{445}, \u{456}\u{43C}\u{2019}\u{44F} \u{44F}\u{43A}\u{438}\u{445} \u{43F}\u{43E}\u{447}\u{438}\u{43D}\u{430}\u{454}\u{442}\u{44C}\u{441}\u{44F} \u{43D}\u{430} \u{201C}\u{410}\u{201D}</button></li>
       <li class="scientists-item scientists-item--odd"><button id="btn-latestBorn" class="scientists-btn scientists-btn--odd">\u{417}\u{43D}\u{430}\u{439}\u{442}\u{438} \u{432}\u{447}\u{435}\u{43D}\u{43E}\u{433}\u{43E}, \u{44F}\u{43A}\u{438}\u{439} \u{43D}\u{430}\u{440}\u{43E}\u{434}\u{438}\u{432}\u{441}\u{44F} \u{43D}\u{430}\u{439}\u{43F}\u{456}\u{437}\u{43D}\u{456}\u{448}\u{435}</button></li>
       <li class="scientists-item scientists-item--longshor scientists-item--even"><button id="btn-longShort" class="scientists-btn">\u{417}\u{43D}\u{430}\u{439}\u{442}\u{438} \u{432}\u{447}\u{435}\u{43D}\u{43E}\u{433}\u{43E}, \u{44F}\u{43A}\u{438}\u{439} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432} \u{43D}\u{430}\u{439}\u{434}\u{43E}\u{432}\u{448}\u{435} \u{456} \u{432}\u{447}\u{435}\u{43D}\u{43E}\u{433}\u{43E}, 
\u{44F}\u{43A}\u{438}\u{439} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432} \u{43D}\u{430}\u{439}\u{43C}\u{435}\u{43D}\u{448}\u{435}</button></li>
       <li class="scientists-item"><button id="btn-sameInitials" class="scientists-btn scientists-btn--1">1. \u{417}\u{43D}\u{430}\u{439}\u{442}\u{438} \u{432}\u{447}\u{435}\u{43D}\u{438}\u{445}, \u{432} \u{44F}\u{43A}\u{438}\u{445} \u{441}\u{43F}\u{456}\u{432}\u{43F}\u{430}\u{434}\u{430}\u{44E}\u{442}\u{44C} \u{43F}\u{435}\u{440}\u{448}\u{456} \u{43B}\u{456}\u{442}\u{435}\u{440}\u{438} \u{456}\u{43C}\u{435}\u{43D}\u{456} \u{456} \u{43F}\u{440}\u{456}\u{437}\u{432}\u{438}\u{449}\u{430}</button></li>
     </ul>
  `;let t=e.querySelector(".scientists-cards"),u=()=>Array.from(t.querySelectorAll(".scientists-card-item")),s=e=>{let t=e.slice(e.length-9);return(t[0]+t[1]+t[2]+t[3])*1},i=e=>{let t,u,i;return u=(t=e.slice(e.length-9))[5],i=t[6],(u+i+t[7]+t[8])*1-s(e)};e.querySelector("#btn-born19").addEventListener("click",()=>{let e=u().filter(e=>{let t=s(e.textContent);return t>=1801&&t<=1900});t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-sortAlphabet").addEventListener("click",()=>{let e=u().sort((e,t)=>e.textContent.localeCompare(t.textContent));t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-sortLifespan").addEventListener("click",()=>{let e=u().sort((e,t)=>i(t.textContent)-i(e.textContent));t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-latestBorn").addEventListener("click",()=>{let e=u(),i=e[0];e.forEach(e=>{s(e.textContent)>s(i.textContent)&&(i=e)}),t.innerHTML="",t.appendChild(i)}),e.querySelector("#btn-einstein").addEventListener("click",()=>{let e=u(),s=null;e.forEach(e=>{-1!==e.textContent.indexOf("Albert Einstein")&&(s=e)}),null!==s&&(t.innerHTML="",t.appendChild(s))}),e.querySelector("#btn-lastNameC").addEventListener("click",()=>{u().forEach(e=>{"C"!==e.textContent.split(" ")[1][0]&&e.remove()})}),e.querySelector("#btn-removeA").addEventListener("click",()=>{u().forEach(e=>{"A"===e.textContent.split(" ")[0][0]&&e.remove()})}),e.querySelector("#btn-longShort").addEventListener("click",()=>{let e=u(),s=e[0],n=e[0];e.forEach(e=>{let t=i(e.textContent);t>i(s.textContent)&&(s=e),t<i(n.textContent)&&(n=e)}),t.innerHTML="",t.appendChild(s),t.appendChild(n)}),e.querySelector("#btn-sameInitials").addEventListener("click",()=>{u().forEach(e=>{let t=e.textContent.split(" ");t[0][0]!==t[1][0]&&e.remove()})})},id:10,name:"Вчений",category:"acquaintance"},{init:()=>{let e;document.querySelector(".game-id_11").innerHTML=`
            ...
            </div>`;let t=document.querySelector(".tone__controls"),u=document.querySelector(".tone__box--user"),s=document.querySelector(".tone__box--current"),i=document.querySelector(".btn__done"),n=document.querySelector(".btn__next"),o=document.querySelector(".tone__meta"),a=document.querySelector(".similarity"),l=document.querySelectorAll(".tone__range"),r=[],c=[],d=()=>{let t=Math.floor(255*Math.random()),u=Math.floor(255*Math.random()),i=Math.floor(255*Math.random());r=[t,u,i],e=`rgb(${t}, ${u}, ${i})`,s.style.backgroundColor=e},m=()=>{let e=document.querySelector(".tone__range--red").value,t=document.querySelector(".tone__range--green").value,s=document.querySelector(".tone__range--blue").value;c=[e,t,s];let i=`rgb(${e}, ${t}, ${s})`;u.style.backgroundColor=i},p=0;d(),t.addEventListener("input",m),i.addEventListener("click",()=>{let t;m();var s=r,i=c;let n=0;for(let e=0;e<3;e++)n+=100-100*Math.abs(s[e]-i[e])/255;p=Math.floor(n/3),a.style.color=c[0]<167&&c[1]<167&&c[2]<167?"var(--colorBgPrimary)":"var(--colorTextPrimary)",a.textContent=`${p} %`,(t=document.createElement("div")).classList.add("box__reference"),t.style.backgroundColor=e,u.appendChild(t)}),n.addEventListener("click",()=>{d(),u.querySelector(".box__reference").remove(),a.textContent="",l.forEach(e=>{e.value=128}),u.style.backgroundColor="rgb(128, 128, 128)"}),o.addEventListener("click",()=>{i.classList.toggle("is__closed"),n.classList.toggle("is__closed"),t.classList.toggle("is__closed")})},id:11,name:"Вгадай колір",category:"game"}],n=document.querySelector("[data-games]"),o=(e,t)=>{t.innerHTML=e.reduce((e,t)=>e+=`      
    <section id="game-id_${t.id}" class="section">
        <div class="container">
          <div class="game game-id_${t.id}">
          </div>
        </div>
      </section>`,""),e.forEach(e=>{e.init&&e.init()})};o(i,n),document.querySelectorAll(".section");let a=document.querySelectorAll(".menu__item");document.querySelectorAll(".menu__text");let l=e=>{let t=e.currentTarget.dataset.category;o(i.filter(e=>e.category===t),n)};a.forEach(e=>{e.addEventListener("click",l)});let r=document.querySelector("html"),c=document.querySelector(".backdrop__header"),d=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let m=document.querySelector(".form__input"),p=document.querySelector(".helloing__text--part");document.querySelector(".form__button");let _=document.querySelector(".seconde__backdrop__header"),v=document.querySelectorAll(".close__button"),g=document.querySelector(".logo__link_photo--white"),y=document.querySelector(".logo__link_photo--dark"),b=document.querySelector(".footer__logo__link_photo--white"),h=document.querySelector(".footer__logo__link_photo--dark");document.querySelectorAll(".game");let E=document.querySelector(".modal__form"),S=document.querySelector(".modal__photo--seconde");document.querySelector(".modals");let C=document.querySelector(".menu__interactive"),f=e=>{S.classList.add("hidden"),c.classList.add("hidden"),_.classList.add("hidden")};d.addEventListener("change",e=>{setTimeout(()=>{e.target.checked?(r.style.setProperty("--colorBgMain","#111111"),r.style.setProperty("--colorCorrect","#66FFFF"),r.style.setProperty("--colorIncorrect","#FC66FF"),r.style.setProperty("--colorBgPrimary","#1a1a1a"),r.style.setProperty("--colorBgSecondary","#262626"),r.style.setProperty("--colorBgField","#282828"),r.style.setProperty("--colorBgSwitch","#858585"),r.style.setProperty("--colorBgChoose","#0E0E0E"),r.style.setProperty("--colorTextPrimary","#ffffffb9"),r.style.setProperty("--colorTextSecondary","#818181"),r.style.setProperty("--colorBgRPS","#282828"),r.style.setProperty("--colorBgPaginationBullet","#2d2d2d"),g.classList.add("dark_logo"),y.classList.add("dark_logo"),b.classList.add("dark_logo"),h.classList.add("dark_logo"),C.classList.add("dark")):(r.style.setProperty("--colorBgMain","#eeeeee"),r.style.setProperty("--colorCorrect","#039900"),r.style.setProperty("--colorIncorrect","#990000"),r.style.setProperty("--colorBgPrimary","#ffffff"),r.style.setProperty("--colorBgSecondary","#d9d9d9"),r.style.setProperty("--colorBgField","#d7d7d7"),r.style.setProperty("--colorBgSwitch","#7a7a7a"),r.style.setProperty("--colorBgChoose","#f1f1f1"),r.style.setProperty("--colorTextPrimary","#000000"),r.style.setProperty("--colorTextSecondary","#7e7e7e"),r.style.setProperty("--colorBgPaginationBullet","#d9d9d9"),g.classList.remove("dark_logo"),y.classList.remove("dark_logo"),b.classList.remove("dark_logo"),h.classList.remove("dark_logo"),C.classList.remove("dark"))},250)}),m.addEventListener("input",e=>{p.textContent=e.target.value}),E.addEventListener("submit",e=>{e.preventDefault(),_.classList.remove("hidden")}),v.forEach(e=>{e.addEventListener("click",f)});let L=document.querySelector(".footer-form"),q=document.querySelector("[data-modal]"),x=document.querySelector("[data-modal-close]");console.log("Форма:",L),console.log("Бекдроп:",q),console.log("Кнопка закриття:",x),L.addEventListener("submit",e=>{e.preventDefault(),q.classList.remove("is-hidden"),L.reset()}),x.addEventListener("click",e=>{e.preventDefault(),q.classList.add("is-hidden")});
//# sourceMappingURL=Magic-coding__Project.fe469de0.js.map
