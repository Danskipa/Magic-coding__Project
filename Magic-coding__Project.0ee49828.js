var e="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},t={},u={},o=e.parcelRequire1ad7;null==o&&((o=function(e){if(e in t)return t[e].exports;if(e in u){var o=u[e];delete u[e];var r={id:e,exports:{}};return t[e]=r,o.call(r.exports,r,r.exports),r.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){u[e]=t},e.parcelRequire1ad7=o),o.register,Object.assign(o.i??={},{hVAk2:"arrow-check.d4bc1386.svg"}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
...
`;let s=e.querySelector(".rps-text"),a=e.querySelector("#cpu-score"),l=e.querySelector("#player-score"),n=e.querySelectorAll(".rps-button__option"),i=e.querySelector(".rps-button"),c=e=>{o=e.target.dataset.choice};i.addEventListener("click",e=>{let n=r[Math.floor(Math.random()*r.length)];"rock"===o&&"rock"===n?(s.textContent="Нічия в цьому раунді!",s.style.color="#000000"):"rock"===o&&"scissors"===n?(u++,s.textContent="Ви виграли раунд!",s.style.color="#039900"):"rock"===o&&"paper"===n&&(t++,s.textContent="Комп’ютер виграв раунд!",s.style.color="#990000"),"scissors"===o&&"scissors"===n?(s.textContent="Нічия в цьому раунді!",s.style.color="#000000"):"scissors"===o&&"paper"===n?(u++,s.textContent="Ви виграли раунд!",s.style.color="#039900"):"scissors"===o&&"rock"===n&&(t++,s.textContent="Комп’ютер виграв раунд!",s.style.color="#990000"),"paper"===o&&"paper"===n?(s.textContent="Нічия в цьому раунді!",s.style.color="#000000"):"paper"===o&&"rock"===n?(u++,s.textContent="Ви виграли раунд!",s.style.color="#039900"):"paper"===o&&"scissors"===n&&(t++,s.textContent="Комп’ютер виграв раунд!",s.style.color="#990000"),a.textContent=`\u{41A}\u{43E}\u{43C}\u{43F}'\u{44E}\u{442}\u{435}\u{440} - ${t}`,l.textContent=`\u{412}\u{438} - ${u}`}),n.forEach(e=>{e.addEventListener("click",c)})},id:3,name:"Камінь-Ножиці-Папір",category:"game"},{init:()=>{document.querySelector(".game-id_4").innerHTML=`<h2 class="calculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440}</h2>
        ...
        </div>`;let e=document.querySelector(".number__first"),t=document.querySelector(".numbe__second"),u=document.querySelector(".calculator__actions"),o=document.querySelector(".calculate"),r=document.querySelector(".result"),s="",a=0;u.addEventListener("click",e=>{document.querySelectorAll(".action").forEach(e=>{e.classList.remove("choose")}),e.target.classList.add("choose"),s=e.target.dataset.action}),o.addEventListener("click",u=>{a=0;let o=Number(e.value),l=Number(t.value);switch(console.log(o),s){case"add":r.textContent=a=o+l;break;case"mul":r.textContent=a=o*l;break;case"sub":r.textContent=a=o-l;break;case"div":0===l?r.textContent="На 0 ділити не можна":(a=o/l)%1==0?r.textContent=a:r.textContent=a.toFixed(2)}})},id:4,name:"Калькулятор",category:"numerical"},{init:()=>{document.querySelector(".game-id_5").innerHTML=`<h2 class="time-\u{441}alculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440} \u{447}\u{430}\u{441}\u{443}</h2>
...
<p class="biggest-num__text">\u{41D}\u{430}\u{439}\u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} \u{447}\u{438}\u{441}\u{43B}\u{43E}, \u{44F}\u{43A}\u{435} \u{432}\u{438} \u{432}\u{432}\u{435}\u{43B}\u{438} - (<span class="biggest-num__text--part">\u{447}\u{438}\u{441}\u{43B}\u{43E}</span>)</p>      </div>`;let e=document.querySelector("#biggest-num__input--one"),t=document.querySelector("#biggest-num__input--two"),u=document.querySelector("#biggest-num__input--three"),o=document.querySelector(".biggest-num__text--part"),r=()=>{let r=[Number(e.value),Number(t.value),Number(u.value)],s=r[0];for(let e=0;e<r.length;e++)r[e]>s&&(s=r[e]);o.textContent=`${0===s?"число":s}`};e.addEventListener("input",r),t.addEventListener("input",r),u.addEventListener("input",r)},id:8,name:"Найбільше число",category:"numerical"},{id:9,name:"Наша команда",category:"acquaintance"},{id:10,name:"Вчений",category:"acquaintance"},{init:()=>{let e;document.querySelector(".game-id_11").innerHTML=`
            ...
            </div>`;let t=document.querySelector(".tone__controls"),u=document.querySelector(".tone__box--user"),o=document.querySelector(".tone__box--current"),r=document.querySelector(".btn__done"),s=document.querySelector(".btn__next"),a=document.querySelector(".tone__meta"),l=document.querySelector(".similarity"),n=document.querySelectorAll(".tone__range"),i=[],c=[],d=()=>{let t=Math.floor(255*Math.random()),u=Math.floor(255*Math.random()),r=Math.floor(255*Math.random());i=[t,u,r],e=`rgb(${t}, ${u}, ${r})`,o.style.backgroundColor=e},m=()=>{let e=document.querySelector(".tone__range--red").value,t=document.querySelector(".tone__range--green").value,o=document.querySelector(".tone__range--blue").value;c=[e,t,o];let r=`rgb(${e}, ${t}, ${o})`;u.style.backgroundColor=r},_=0;d(),t.addEventListener("input",m),r.addEventListener("click",()=>{let t;m();var o=i,r=c;let s=0;for(let e=0;e<3;e++)s+=100-100*Math.abs(o[e]-r[e])/255;_=Math.floor(s/3),l.style.color=c[0]<167&&c[1]<167&&c[2]<167?"var(--colorBgPrimary)":"var(--colorTextPrimary)",l.textContent=`${_} %`,(t=document.createElement("div")).classList.add("box__reference"),t.style.backgroundColor=e,u.appendChild(t)}),s.addEventListener("click",()=>{d(),u.querySelector(".box__reference").remove(),l.textContent="",n.forEach(e=>{e.value=128}),u.style.backgroundColor="rgb(128, 128, 128)"}),a.addEventListener("click",()=>{r.classList.toggle("is__closed"),s.classList.toggle("is__closed"),t.classList.toggle("is__closed")})},id:11,name:"Вгадай колір",category:"game"}],s=document.querySelector("html"),a=document.querySelector(".modal"),l=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let n=document.querySelector(".form__input"),i=document.querySelector(".helloing__text--part"),c=document.querySelector(".form__button"),d=document.querySelector(".seconde__modal"),m=document.querySelector(".close__button");document.querySelector(".logo__link--picture");let _=document.querySelector(".logo__link_photo--white"),g=document.querySelector(".logo__link_photo--dark"),p=document.querySelectorAll(".menu__item");document.querySelectorAll(".game");let y=document.querySelectorAll(".section"),h=document.querySelector(".modal__form");l.addEventListener("change",e=>{e.target.checked?(s.style.setProperty("--colorCorrect","#ff0086"),s.style.setProperty("--colorIncorrect","#00ff48"),s.style.setProperty("--colorBgPrimary","#000000"),s.style.setProperty("--colorBgSecondary","#595959"),s.style.setProperty("--colorTextPrimary","#ffffff"),_.classList.add("dark_logo"),g.classList.add("dark_logo"),p.forEach(e=>{e.classList.add("menu__item--dark")})):(s.style.setProperty("--colorCorrect","#039900"),s.style.setProperty("--colorIncorrect","#990000"),s.style.setProperty("--colorBgPrimary","#ffffff"),s.style.setProperty("--colorBgSecondary","#d9d9d9"),s.style.setProperty("--colorBgField","#d7d7d7"),s.style.setProperty("--colorBgSwitch","#7a7a7a"),s.style.setProperty("--colorBgChoose","#f1f1f1"),s.style.setProperty("--colorTextPrimary","#000000"),s.style.setProperty("--colorTextSecondary","#7e7e7e"),_.classList.remove("dark_logo"),g.classList.remove("dark_logo"),p.forEach(e=>{e.classList.remove("menu__item--dark")}))}),n.addEventListener("input",e=>{i.textContent=e.target.value}),h.addEventListener("submit",e=>{e.preventDefault(),c&&d.classList.remove("hidden")}),m.addEventListener("click",e=>{m&&(a.classList.add("hidden"),d.classList.add("hidden"))}),document.querySelectorAll(".menu__text");let b=e=>{let t=e.currentTarget.dataset.category;y.forEach((e,u)=>{r[u].category===t?e.style.display="block":e.style.display="none"})};p.forEach(e=>{e.addEventListener("click",b)}),document.querySelector("[data-games]").innerHTML=r.reduce((e,t)=>e+=`      
    <section id="game-id_${t.id}" class="section">
        <div class="container">
          <div class="game game-id_${t.id}">
          </div>
        </div>
      </section>`,""),r.forEach(e=>{e.init&&e.init()});let v=document.querySelector(".footer-form"),S=document.querySelector("[data-modal]"),f=document.querySelector("[data-modal-close]");console.log("Форма:",v),console.log("Бекдроп:",S),console.log("Кнопка закриття:",f),v.addEventListener("submit",e=>{e.preventDefault(),S.classList.remove("is-hidden"),v.reset()}),f.addEventListener("click",e=>{e.preventDefault(),S.classList.add("is-hidden")});
//# sourceMappingURL=Magic-coding__Project.0ee49828.js.map
