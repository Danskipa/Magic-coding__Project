let e=document.querySelector(".modal"),u=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let t=document.querySelector(".form__input"),n=document.querySelector(".helloing__text--part"),a=document.querySelector(".form__button"),c=document.querySelector(".seconde__modal"),l=document.querySelector(".close__button");document.querySelector(".logo__link--picture");let i=document.querySelector(".logo__img");u.addEventListener("change",e=>{e.target.checked?(document.body.classList.add("dark"),logoPickture.classList.add("logo__photo--dark"),i.src="./images/logo.svg"):(document.body.classList.remove("dark"),logoPickture.classList.remove("logo__photo--dark"),i.src="./images/logo_dark.svg")}),t.addEventListener("input",e=>{n.textContent=e.target.value}),a.addEventListener("click",e=>{a&&c.classList.remove("hidden")}),l.addEventListener("click",u=>{l&&(e.classList.add("hidden"),c.classList.add("hidden"))}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
  ...
  `;let u=e.querySelector(".guess-input"),t=e.querySelector(".guess-subtitle"),n=Math.floor(100*Math.random())+1;u.addEventListener("input",e=>{let u=Number(e.target.value);u===n?t.textContent=`\u{412}\u{456}\u{442}\u{430}\u{44E}, \u{432}\u{438} \u{432}\u{433}\u{430}\u{434}\u{430}\u{43B}\u{438} \u{447}\u{438}\u{441}\u{43B}\u{43E}! (${n})`:u>n?t.textContent="Занадто велике число":t.textContent="Занадто мале число"})});let o=[{id:1,name:"Високосний калькулятор",category:"numerical"},{init:void 0,id:2,name:"Вгадай число",category:"numerical"},{id:3,name:"Камінь-Ножиці-Папір",category:"game"},{init:()=>{document.querySelector(".game-id_4").innerHTML=`<h2 class="calculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440}</h2>
        ...
        </div>`;let e=document.querySelector(".number__first"),u=document.querySelector(".numbe__second"),t=document.querySelector(".calculator__actions"),n=document.querySelector(".calculate"),a=document.querySelector(".result"),c="",l=0;t.addEventListener("click",e=>{document.querySelectorAll(".action").forEach(e=>{e.classList.remove("choose")}),e.target.classList.add("choose"),c=e.target.dataset.action}),n.addEventListener("click",t=>{l=0;let n=Number(e.value),i=Number(u.value);switch(console.log(n),c){case"add":a.textContent=l=n+i;break;case"mul":a.textContent=l=n*i;break;case"sub":a.textContent=l=n-i;break;case"div":0===i?a.textContent="На 0 ділити не можна":(l=n/i)%1==0?a.textContent=l:a.textContent=l.toFixed(2)}})},id:4,name:"Калькулятор",category:"numerical"},{init:()=>{document.querySelector(".game-id_5").innerHTML=`<h2 class="time-\u{441}alculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440} \u{447}\u{430}\u{441}\u{443}</h2>
...
<p class="biggest-num__text">\u{41D}\u{430}\u{439}\u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} \u{447}\u{438}\u{441}\u{43B}\u{43E}, \u{44F}\u{43A}\u{435} \u{432}\u{438} \u{432}\u{432}\u{435}\u{43B}\u{438} - (<span class="biggest-num__text--part">\u{447}\u{438}\u{441}\u{43B}\u{43E}</span>)</p>      </div>`;let e=document.querySelector("#biggest-num__input--one"),u=document.querySelector("#biggest-num__input--two"),t=document.querySelector("#biggest-num__input--three"),n=document.querySelector(".biggest-num__text--part"),a=()=>{let a=[Number(e.value),Number(u.value),Number(t.value)],c=a[0];for(let e=0;e<a.length;e++)a[e]>c&&(c=a[e]);n.textContent=`${0===c?"число":c}`};e.addEventListener("input",a),u.addEventListener("input",a),t.addEventListener("input",a)},id:8,name:"Найбільше число",category:"numerical"},{id:9,name:"Наша команда",category:"acquaintance"},{id:10,name:"Вчений",category:"acquaintance"}];document.querySelector("[data-games]").innerHTML=o.reduce((e,u)=>e+=`      
...
//# sourceMappingURL=Magic-coding__Project.7b94a668.js.map
