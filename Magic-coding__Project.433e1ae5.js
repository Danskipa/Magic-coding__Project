var e="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},t={},u={},s=e.parcelRequire1ad7;null==s&&((s=function(e){if(e in t)return t[e].exports;if(e in u){var s=u[e];delete u[e];var i={id:e,exports:{}};return t[e]=i,s.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){u[e]=t},e.parcelRequire1ad7=s),s.register,Object.assign(s.i??={},{hVAk2:"arrow-check.d4bc1386.svg"});let i=document.querySelector("html"),n=document.querySelector(".backdrop__header"),a=document.querySelector(".switcher");document.querySelector(".helloing__text--part");let l=document.querySelector(".form__input"),r=document.querySelector(".helloing__text--part");document.querySelector(".form__button");let o=document.querySelector(".seconde__backdrop__header"),c=document.querySelector(".close__button");document.querySelector(".logo__link--picture");let d=document.querySelector(".logo__link_photo--white"),m=document.querySelector(".logo__link_photo--dark");document.querySelectorAll(".game");let _=document.querySelector(".modal__form"),p=document.querySelector(".modal__photo--seconde"),g=document.querySelector(".modals");a.addEventListener("change",e=>{e.target.checked?(i.style.setProperty("--colorBgPrimary","#000000db"),i.style.setProperty("--colorTextPrimary","#ffffffb9"),d.classList.add("dark_logo"),m.classList.add("dark_logo"),menuItems.forEach(e=>{e.classList.add("menu__item--dark")})):(i.style.setProperty("--colorCorrect","#039900"),i.style.setProperty("--colorIncorrect","#990000"),i.style.setProperty("--colorBgPrimary","#ffffff"),i.style.setProperty("--colorBgSecondary","#d9d9d9"),i.style.setProperty("--colorBgField","#d7d7d7"),i.style.setProperty("--colorBgSwitch","#7a7a7a"),i.style.setProperty("--colorBgChoose","#f1f1f1"),i.style.setProperty("--colorTextPrimary","#000000"),i.style.setProperty("--colorTextSecondary","#7e7e7e"),d.classList.remove("dark_logo"),m.classList.remove("dark_logo"),menuItems.forEach(e=>{e.classList.remove("menu__item--dark")}))}),l.addEventListener("input",e=>{r.textContent=e.target.value}),_.addEventListener("submit",e=>{e.preventDefault(),o.classList.remove("hidden")}),c.addEventListener("click",e=>{p.classList.add("hidden"),n.classList.add("hidden"),o.classList.add("hidden"),g.classList.add("hidden")}),document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".game-id_2");e.innerHTML=`
...
`;let n=e.querySelector(".rps-text"),a=e.querySelector("#cpu-score"),l=e.querySelector("#player-score"),r=e.querySelectorAll(".rps-button__option"),o=e.querySelector(".rps-button"),c=e.querySelectorAll(".rps-item"),d=e=>{s=e.target.dataset.choice,c.forEach(e=>e.classList.remove("active")),e.target.parentElement.classList.add("active")};o.addEventListener("click",e=>{let r=i[Math.floor(Math.random()*i.length)];"rock"===s&&"rock"===r?(n.textContent="Нічия в цьому раунді!",n.style.color="#000000"):"rock"===s&&"scissors"===r?(u++,n.textContent="Ви виграли раунд!",n.style.color="#039900"):"rock"===s&&"paper"===r&&(t++,n.textContent="Комп’ютер виграв раунд!",n.style.color="#990000"),"scissors"===s&&"scissors"===r?(n.textContent="Нічия в цьому раунді!",n.style.color="#000000"):"scissors"===s&&"paper"===r?(u++,n.textContent="Ви виграли раунд!",n.style.color="#039900"):"scissors"===s&&"rock"===r&&(t++,n.textContent="Комп’ютер виграв раунд!",n.style.color="#990000"),"paper"===s&&"paper"===r?(n.textContent="Нічия в цьому раунді!",n.style.color="#000000"):"paper"===s&&"rock"===r?(u++,n.textContent="Ви виграли раунд!",n.style.color="#039900"):"paper"===s&&"scissors"===r&&(t++,n.textContent="Комп’ютер виграв раунд!",n.style.color="#990000"),s="",a.textContent=`\u{41A}\u{43E}\u{43C}\u{43F}'\u{44E}\u{442}\u{435}\u{440} - ${t}`,l.textContent=`\u{412}\u{438} - ${u}`}),r.forEach(e=>{e.addEventListener("click",d)})},id:3,name:"Камінь-Ножиці-Папір",category:"game"},{init:()=>{document.querySelector(".game-id_4").innerHTML=`<h2 class="calculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440}</h2>
        ...
        </div>`;let e=document.querySelector(".number__first"),t=document.querySelector(".numbe__second"),u=document.querySelector(".calculator__actions"),s=document.querySelector(".calculate"),i=document.querySelector(".result"),n="",a=0;u.addEventListener("click",e=>{document.querySelectorAll(".action").forEach(e=>{e.classList.remove("choose")}),e.target.classList.add("choose"),n=e.target.dataset.action}),s.addEventListener("click",u=>{a=0;let s=Number(e.value),l=Number(t.value);switch(console.log(s),n){case"add":i.textContent=a=s+l;break;case"mul":i.textContent=a=s*l;break;case"sub":i.textContent=a=s-l;break;case"div":0===l?i.textContent="На 0 ділити не можна":(a=s/l)%1==0?i.textContent=a:i.textContent=a.toFixed(2)}})},id:4,name:"Калькулятор",category:"numerical"},{init:()=>{document.querySelector(".game-id_5").innerHTML=`<h2 class="time-\u{441}alculator__title">\u{41A}\u{430}\u{43B}\u{44C}\u{43A}\u{443}\u{43B}\u{44F}\u{442}\u{43E}\u{440} \u{447}\u{430}\u{441}\u{443}</h2>
...
<p class="biggest-num__text">\u{41D}\u{430}\u{439}\u{431}\u{456}\u{43B}\u{44C}\u{448}\u{435} \u{447}\u{438}\u{441}\u{43B}\u{43E}, \u{44F}\u{43A}\u{435} \u{432}\u{438} \u{432}\u{432}\u{435}\u{43B}\u{438} - (<span class="biggest-num__text--part">\u{447}\u{438}\u{441}\u{43B}\u{43E}</span>)</p>      </div>`;let e=document.querySelector("#biggest-num__input--one"),t=document.querySelector("#biggest-num__input--two"),u=document.querySelector("#biggest-num__input--three"),s=document.querySelector(".biggest-num__text--part"),i=()=>{let i=[Number(e.value),Number(t.value),Number(u.value)],n=i[0];for(let e=0;e<i.length;e++)i[e]>n&&(n=i[e]);s.textContent=`${0===n?"число":n}`};e.addEventListener("input",i),t.addEventListener("input",i),u.addEventListener("input",i)},id:8,name:"Найбільше число",category:"numerical"},{id:9,name:"Наша команда",category:"acquaintance"},{init:()=>{let e=document.querySelector(".game-id_10");e.innerHTML=`
  ...
  `;let t=e.querySelector(".scientists-cards"),u=()=>Array.from(t.querySelectorAll(".scientists-card-item")),s=e=>{let t=e.slice(e.length-9);return(t[0]+t[1]+t[2]+t[3])*1},i=e=>{let t,u,i;return u=(t=e.slice(e.length-9))[5],i=t[6],(u+i+t[7]+t[8])*1-s(e)};e.querySelector("#btn-born19").addEventListener("click",()=>{let e=u().filter(e=>{let t=s(e.textContent);return t>=1801&&t<=1900});t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-sortAlphabet").addEventListener("click",()=>{let e=u().sort((e,t)=>e.textContent.localeCompare(t.textContent));t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-sortLifespan").addEventListener("click",()=>{let e=u().sort((e,t)=>i(t.textContent)-i(e.textContent));t.innerHTML="",e.forEach(e=>t.appendChild(e))}),e.querySelector("#btn-latestBorn").addEventListener("click",()=>{let e=u(),i=e[0];e.forEach(e=>{s(e.textContent)>s(i.textContent)&&(i=e)}),t.innerHTML="",t.appendChild(i)}),e.querySelector("#btn-einstein").addEventListener("click",()=>{let e=u(),s=null;e.forEach(e=>{-1!==e.textContent.indexOf("Albert Einstein")&&(s=e)}),null!==s&&(t.innerHTML="",t.appendChild(s))}),e.querySelector("#btn-lastNameC").addEventListener("click",()=>{u().forEach(e=>{"C"!==e.textContent.split(" ")[1][0]&&e.remove()})}),e.querySelector("#btn-removeA").addEventListener("click",()=>{u().forEach(e=>{"A"===e.textContent.split(" ")[0][0]&&e.remove()})}),e.querySelector("#btn-longShort").addEventListener("click",()=>{let e=u(),s=e[0],n=e[0];e.forEach(e=>{let t=i(e.textContent);t>i(s.textContent)&&(s=e),t<i(n.textContent)&&(n=e)}),t.innerHTML="",t.appendChild(s),t.appendChild(n)}),e.querySelector("#btn-sameInitials").addEventListener("click",()=>{u().forEach(e=>{let t=e.textContent.split(" ");t[0][0]!==t[1][0]&&e.remove()})})},id:10,name:"Вчений",category:"acquaintance"},{init:()=>{let e;document.querySelector(".game-id_11").innerHTML=`
            ...
            </div>`;let t=document.querySelector(".tone__controls"),u=document.querySelector(".tone__box--user"),s=document.querySelector(".tone__box--current"),i=document.querySelector(".btn__done"),n=document.querySelector(".btn__next"),a=document.querySelector(".tone__meta"),l=document.querySelector(".similarity"),r=document.querySelectorAll(".tone__range"),o=[],c=[],d=()=>{let t=Math.floor(255*Math.random()),u=Math.floor(255*Math.random()),i=Math.floor(255*Math.random());o=[t,u,i],e=`rgb(${t}, ${u}, ${i})`,s.style.backgroundColor=e},m=()=>{let e=document.querySelector(".tone__range--red").value,t=document.querySelector(".tone__range--green").value,s=document.querySelector(".tone__range--blue").value;c=[e,t,s];let i=`rgb(${e}, ${t}, ${s})`;u.style.backgroundColor=i},_=0;d(),t.addEventListener("input",m),i.addEventListener("click",()=>{let t;m();var s=o,i=c;let n=0;for(let e=0;e<3;e++)n+=100-100*Math.abs(s[e]-i[e])/255;_=Math.floor(n/3),l.style.color=c[0]<167&&c[1]<167&&c[2]<167?"var(--colorBgPrimary)":"var(--colorTextPrimary)",l.textContent=`${_} %`,(t=document.createElement("div")).classList.add("box__reference"),t.style.backgroundColor=e,u.appendChild(t)}),n.addEventListener("click",()=>{d(),u.querySelector(".box__reference").remove(),l.textContent="",r.forEach(e=>{e.value=128}),u.style.backgroundColor="rgb(128, 128, 128)"}),a.addEventListener("click",()=>{i.classList.toggle("is__closed"),n.classList.toggle("is__closed"),t.classList.toggle("is__closed")})},id:11,name:"Вгадай колір",category:"game"}],y=document.querySelector("[data-games]"),v=(e,t)=>{t.innerHTML=e.reduce((e,t)=>e+=`      
    <section id="game-id_${t.id}" class="section">
        <div class="container">
          <div class="game game-id_${t.id}">
          </div>
        </div>
      </section>`,""),e.forEach(e=>{e.init&&e.init()})};v(b,y),document.querySelectorAll(".section");let h=document.querySelectorAll(".menu__item");document.querySelectorAll(".menu__text");let E=e=>{let t=e.currentTarget.dataset.category;v(b.filter(e=>e.category===t),y)};h.forEach(e=>{e.addEventListener("click",E)});let S=document.querySelector(".footer-form"),C=document.querySelector("[data-modal]"),f=document.querySelector("[data-modal-close]");console.log("Форма:",S),console.log("Бекдроп:",C),console.log("Кнопка закриття:",f),S.addEventListener("submit",e=>{e.preventDefault(),C.classList.remove("is-hidden"),S.reset()}),f.addEventListener("click",e=>{e.preventDefault(),C.classList.add("is-hidden")});
//# sourceMappingURL=Magic-coding__Project.433e1ae5.js.map
